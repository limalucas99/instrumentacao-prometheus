...
import sys
import platform
from metrics import request_duration_histogram, cart_addition_total, errors_total, active_sessions_gauge, cpu_usage_gauge, update_cpu_usage, update_active_sessions
